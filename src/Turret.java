...
public class Turret extends SuperTank {
    ...
    public void shoot() {
        Bullet bullet = new Bullet(positionX + (87), positionY + (67), GameState.tankPosition().x + (GameState.getTank().image.getWidth() / 2), GameState.tankPosition().y + (GameState.getTank().image.getHeight() / 2), bulletImageAddress, 20,damage);
